...
export default function Backyard() {
  ...
  const override = useServiceOverride("backyard");
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[70vh] w-full overflow-hidden">
        ...
        <img
          src={override?.banner || "/services/backyard-banner.png"}
          alt="Backyard"
        ...
        <div className="relative h-full flex items-center justify-center text-center px-6">
          ...
          >
            {override?.title || "Backyard Transformation"}
          </h1>
      ...
      <section className="py-32 px-6 lg:px-8 max-w-5xl mx-auto text-center">
        ...
        >
          {override?.intro ||
            "Transform your backyard into a luxury outdoor environment designed for relaxation, entertainment and lifestyle."
          }
        </p>
      ...
      >
        ...
        <img
          src={override?.image1 || "/services/backyard1.jpeg"}
          alt="Backyard"
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-light mb-6">
            {override?.block1_title || "Complete Outdoor Renovation"}
          </h2>

          <p className="text-gray-600 leading-relaxed">
            {override?.block1_text ||
              "We redesign your outdoor space to create functional, elegant and cohesive environments tailored to your lifestyle."
            }
          </p>
      ...
      >
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-light mb-6">
            {override?.block2_title || "Designed for Lifestyle"}
          </h2>

          <p className="text-gray-600 leading-relaxed">
            {override?.block2_text ||
              "From patios to outdoor kitchens, we create spaces that enhance comfort, beauty and functionality."
            }
          </p>
        ...
        <img
          src={override?.image2 || "/services/backyard2.jpeg"}
          alt="Backyard"
          className="w-full h-[500px] object-cover"
        />
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-12 text-center">
          ...
          <div>
            <h3 className="text-xl font-light mb-4">
              {override?.process1_title || "Planning"}
            </h3>
            <p className="text-white/80">
              {override?.process1_text ||
                "We analyze your space and define the best transformation strategy."
              }
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-white/80">
              {override?.process2_text ||
                "We create a custom design aligned with your vision and needs."
              }
            </p>
          </div>
          ...
          <div>
            <h3 className="text-xl font-light mb-4">
              {override?.process3_title || "Execution"}
            </h3>
            <p className="text-white/80">
              {override?.process3_text ||
                "We bring your project to life with precision and quality."
              }
            </p>
          </div>
